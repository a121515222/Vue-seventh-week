        ...
        <div class="modal-body">
          <div class="row row-cols-2">
            ...
            <div class="from-group py-2 d-flex gap-3">
              ...
              <SwitchClick id="articleIsenable" :info="article.id" :enabled="article.isPublic === true? 1:0" @send-enable="getActive"></SwitchClick>
            </div>
            <div class="from-group py-2">
          ...
          <div class="row pt-2">
            <div class="from-group d-flex gap-2">
              ...
              <div  v-for="(item, index) in article.tag" :key="index" class="input-group w-15">
                ...
                <button type="button" class="input-group-text" @click="deleteTag(index)" :disabled="isLoading === true" :class="{'buttonDisabledCursor': isLoading === true}">
              ...
              <button type="button" v-if="article.tag?.length < 5" class="btn btn-outline-primary" @click="addTag">增加標籤</button>
            </div>
          </div>
          <div class="row pt-2">
